...
import { animatetrigger, animatewithGsap } from '../constants/animations'
...
const ModelSelect = () => {
    ...
    useGSAP(() => {
        animatetrigger('#heading',{y:0 ,opacity:1,ease:'power.Out', duration:1})
        })
